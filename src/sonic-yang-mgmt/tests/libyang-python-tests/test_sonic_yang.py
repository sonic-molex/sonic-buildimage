...
class Test_SonicYang(object):
    ...
    def test_validate_yang_models(self, sonic_yang_data):
        ...
        # Currently 5 YANG files are not directly related to config, along with event YANG models
        # which are: sonic-extension.yang, sonic-types.yang, sonic-bgp-common.yang,
        # sonic-alarm.yang and sonic-event.yang. Hard coding it right now.
