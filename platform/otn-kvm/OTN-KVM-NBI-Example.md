...
## CLI Support for OTN
Auto-generation tool is used to support SONiC OTN CLIs at device level, i.e., only the CLIs applicable for the device will be available on the device. Please see design [here](./sonic-yanggen/README.md).
- all sonic yangs are generated at build time and included in the image for otn device.
- only sonic yangs are applicable to the specific device is loaded during startup and CLIs are generated.

### Feature Examples ()
- show attenuator config
  ```
  show otn-attenuator
  ```
  
- show attenuator state
  ```
  show otne-attenuator-state
  ```
...
The implementation supports multiple levels of wildcarding to allow for flexible data retrieval across the entire OTN device suite.
1. Entry Wildcards ([name=*]) You can subscribe to all entries in a list by using the * wildcard in the key field. This triggers the Key Transformer to scan the appropriate database—STATE_DB for dynamic data or CONFIG_DB for settings—and return every discovered instance.
```bash
...
{
  "source": "127.0.0.1:8080",
  "subscription-name": "default-1769018072",
  "timestamp": 1769018071510415849,
  "time": "2026-01-21T12:54:31.510415849-05:00",
  "prefix": "openconfig-optical-attenuator:optical-attenuator/attenuators/attenuator[name=VOA0-1]/state",
  "target": "OC-YANG",
  "updates": [
    {
      "Path": "output-power-total/instant",
    ...
    },
    {
      "Path": "actual-attenuation/instant",
      "values": {
        "actual-attenuation/instant": 3.2
      }
    },
    {
      "Path": "attenuation-mode",
...
}
{
  "source": "127.0.0.1:8080",
  "subscription-name": "default-1769018072",
  "timestamp": 1769018071513103608,
  "time": "2026-01-21T12:54:31.513103608-05:00",
  "prefix": "openconfig-optical-attenuator:optical-attenuator/attenuators/attenuator[name=VOA0-0]/state",
  "target": "OC-YANG",
  "updates": [
    {
      "Path": "actual-attenuation/instant",
      "values": {
        "actual-attenuation/instant": 4.2
      }
    },
    {
      "Path": "enabled",
...
```
2. Path Wildcards (Leaf node discovery) By subscribing to a parent container, the Table Transformer recursively discovers all underlying list members. This is useful for fetching the entire hierarchy of a device in one stream.
```bash
...
```json
"source": "127.0.0.1:8080",
  "subscription-name": "default-1769018525",
  "timestamp": 1769018524512583700,
  "time": "2026-01-21T13:02:04.512583624-05:00",
  "prefix": "openconfig-channel-monitor:channel-monitors/channel-monitor[name=OCM0-0]/channels/channel[lower-frequency=194037500][upper-frequency=194112500]",
  "target": "OC-YANG",
  "updates": [
    {
      "Path": "lower-frequency",
      "values": {
        "lower-frequency": 194037500
      }
    },
    {
      "Path": "state/lower-frequency",
      "values": {
        "state/lower-frequency": 194037500
      }
    },
    {
      "Path": "state/power",
    ...
    {
      "Path": "state/target-power",
      "values": {
        "state/target-power": 0.59
      }
    },
    {
      "Path": "state/upper-frequency",
      "values": {
        "state/upper-frequency": 194112500
      }
    },
    {
      "Path": "upper-frequency",
      "values": {
        "upper-frequency": 194112500
      }
    }
  ]
}
{
  "source": "127.0.0.1:8080",
  "subscription-name": "default-1769018525",
  "timestamp": 1769018524514133800,
  "time": "2026-01-21T13:02:04.514133761-05:00",
  "prefix": "openconfig-channel-monitor:channel-monitors/channel-monitor[name=OCM0-0]/channels/channel[lower-frequency=192087500][upper-frequency=192162500]",
  "target": "OC-YANG",
  "updates": [
    {
      "Path": "lower-frequency",
      "values": {
        "lower-frequency": 192087500
      }
    },
    {
      "Path": "state/lower-frequency",
      "values": {
        "state/lower-frequency": 192087500
      }
    },
    {
      "Path": "state/power",
    ...
    },
    {
      "Path": "state/target-power",
      "values": {
        "state/target-power": 0.33
      }
    },
    {
      "Path": "state/upper-frequency",
      "values": {
        "state/upper-frequency": 192162500
      }
    },
    {
      "Path": "upper-frequency",
      "values": {
        "upper-frequency": 192162500
      }
    }
  ]
}
