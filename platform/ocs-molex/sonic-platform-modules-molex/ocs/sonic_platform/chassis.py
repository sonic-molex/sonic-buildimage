...
try:
    ...
    from sonic_platform.component import Component, ComponentHelper
...
class Chassis(ChassisBase):
    """
    molex Platform-specific Chassis class
    """
    ...
    def __init__(self):
        ...
        for item in self.desc['chassis']['components']:
            component = ComponentHelper.create_component_instance(item)
